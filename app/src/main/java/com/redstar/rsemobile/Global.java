...
public class Global {
    ...
    public static String globalURLLocal = "http://mobile.redstarplc.net:1264/service.asmx/";
   ...
   // public static String globalURL = "https://www.redstarplc.com:8444/mobileservice/service.asmx/";
    ...
    public static String globalPodAmount = "";
...
// Global variables for pickup
    ...
    // for manual upload
    public static String UploadMessage ="Upload Complete";
