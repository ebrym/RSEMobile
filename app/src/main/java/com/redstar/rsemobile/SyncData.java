...
//            String CHMPODCount = db.getCHMPODNotUploaded(SyncData.this).toString();
           // Log.d("SYNC: ", "BEGIN " );
            uploadPOD();
            uploadCHMPOD();
            uploadPICKUP();
...
//
    ...
    public void uploadCHMPOD()
    {
        ...
        Cursor cursor = db.getCHMPODNotUploaded(SyncData.this);
        if (cursor.getCount() > 0)
        {
            // POD RECORD EXIST
            if (cursor.moveToFirst()) {
...
//
    ...
    private class uploadData extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            if(arg0[0] == "POD"){
                Log.d("DeviceID: ", db.getDeviceID(SyncData.this) );
                Log.d("UserID: ", db.getUserID(SyncData.this) );
