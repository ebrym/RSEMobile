...
//            }
        ...
        //Log.d("globalDeviceIMEI : ", "> " + Global.globalDeviceIMEI);
       /* startService(new Intent(LoginActivity.this,SyncData.class));
        ...
        btnCrLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Global.AssetDialog("Current Password is Required!!!", LoginActivity.this).create().show();
                ...
                {
                    Global.AssetDialog("Current Password is invalid!!!", LoginActivity.this).create().show();
                    crCuPassword.requestFocus();
                    return;
                }
                ...
                if(newpassword.equals(conNewpassword.toString()))
                {
                    ...
                    /*String sql = "INSERT INTO users" +
                            ...
                            "'" + strDeviceType.toString() + "'),('admin','rse-ng1','" + strDeviceType.toString() + "')";
                    */
                    String sql = "INSERT INTO users" +
                    ...
                    String sql1 = " INSERT INTO users(username,password,Devicetype)VALUES ('admin','rse-ng1','" + strDeviceType.toString() + "');";


                    if (db.dynamicInsert(LoginActivity.this,sql)) {
                        handler.sendEmptyMessage(0);
                        db.dynamicInsert(LoginActivity.this,sql1);
        ...
        if(Global.globalUserCount.equals("0")){
            try{
                ...
                if(rtn.equals("1")){
                    ...
                    lblDeviceStatus.setText("Your device have not been activated. Please contact your administrator.!!!");
