...
import com.redstar.rsemobile.PickUp.AccountDetails;
import com.redstar.rsemobile.PickUp.AlertDetails;
import com.redstar.rsemobile.PickUp.DestinationDetails;
import com.redstar.rsemobile.PickUp.SendDetails;
import com.redstar.rsemobile.PickUp.ShipmentDetails;
import com.redstar.rsemobile.PickUp.pickupInterface;
import com.redstar.rsemobile.PickUp.recipientDetails;
...
//     * The {@link PagerAdapter} that will provide
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSavePickUp.setOnClickListener(new View.OnClickListener() {
            ...
            if (Global.globalPickupAccountNo.length() == 8)
            {
                ...
                if(Global.globalPickupAwbno.toString().equals("") || Global.globalPickupAwbno.toString().equals(" ")
                        || !Global.globalPickupAwbno.toString().matches("^([a-zA-Z0-9][a-zA-Z0-9][a-zA-Z0-9][a-zA-Z0-9][0-9]+$)") || Global.globalPickupAwbno.toString().length() < 8)
                {
